...
(LadiPageScriptV2.prototype.init = function () {
    ...
    (LadiPageScriptV2.prototype.run = function (t) {
        ...
        var d,
            ...
            P = parseFloatLadiPage(window.ladi("LADI_CAMP_PAGE_VIEW").get_cookie()) || 0,
            L = parseFloatLadiPage(window.ladi("LADI_CAMP_FORM_SUBMIT").get_cookie()) || 0,
            ...
            O = function (t, i, a) {
                if ("FormSubmit" == t && e.isEmpty(m)) e.isFunction(a) && a();
                    ...
                    Object.keys(i).forEach(function (t) {
                        ...
                        "FormSubmit" == t &&
                            (e.isEmpty(_) ? g++ : (v == E && g++, L++), window.ladi("LADI_FORM_SUBMIT").set_cookie(g, 3650, window.location.pathname), window.ladi("LADI_CAMP_FORM_SUBMIT").set_cookie(L, 3650, window.location.pathname)),
                        e.sendRequest(
                            "POST",
                            ...
                            !0,
                            {
                                ...
                                LADI_CAMP_PAGE_VIEW: P,
                                LADI_CAMP_FORM_SUBMIT: L,
            ...
            I = function (t, i, a, n) {
                if (!e.isEmpty(i) && "POPUP_PRODUCT" == i.id) {
                    var r = e.generateVariantProduct(a, !1, null, null, null, null, !0, !0, function (e) {
                        I(t, i, a, n);
                    });
                    if (!e.isObject(r) || !e.isObject(r.store_info) || !e.isObject(r.product) || !e.isArray(r.product.variants) || r.product.variants.length <= 0) return;
                    var o = null;
                    if (e.isEmpty(a["option.product_variant_id"])) {
                        ...
                        var l = e.findAncestor(t, "ladi-collection-item"),
                            s = null;
                        if (e.isEmpty(l)) {
                            for (var c = document.querySelectorAll('[data-variant="true"] select[data-store-id="' + r.store_info.id + '"][data-product-id="' + r.product.product_id + '"]'), d = 0; d < c.length; d++)
                    ...
                    for (var p = document.querySelectorAll("#" + i.id + " .ladi-element"), m = 0; m < p.length; m++) e.runtime.tmp.runLadiSaleProductKey(p[m].id, !1, !1, o, r);
                }
                e.isFunction(n) && n();
            },
            N = function (t, i, a, n) {
            ...
            D = function (t, i, a, n, r, o, l, s) {
                "countdown" != a ||
                    ...
                    e.isEmpty(i) ||
                        ...
                        n != e.const.COUNTDOWN_TYPE.endtime || e.isEmpty(s) || i.setAttribute("data-endtime", s),
                        n != e.const.COUNTDOWN_TYPE.daily || e.isEmpty(o) || e.isEmpty(l) || (i.setAttribute("data-daily-start", o), i.setAttribute("data-daily-end", l))));
            },
            x = function (t, i, a, n) {
                ...
                if (e.isEmpty(e.runtime.current_element_mouse_down_gallery_view) && e.isEmpty(e.runtime.current_element_mouse_down_gallery_control)) {
                    ...
                    if (e.isEmpty(e.runtime.timeout_gallery[r]) && (!e.runtime.tmp.gallery_playing_video || !i)) {
                        ...
                        if (0 != o.length && 0 != o.length) {
                            ...
                            var p = 1e3 * (parseFloatLadiPage(getComputedStyle(o[c]).transitionDuration) || 0);
                            ...
                            for (var m = 0; m < l.length; m++) (parseFloatLadiPage(l[m].getAttribute("data-index")) || 0) == c ? l[m].classList.add("selected") : l[m].classList.remove("selected");
                            ...
                            if (t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || t.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                var _ = parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).width) || 0,
                                ...
                                L < (A = (A = -(A -= parseFloatLadiPage(getComputedStyle(t.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : A) && (L = A),
                    ...
                    e.isEmpty(s)
                        ? (n == e.const.VIDEO_TYPE.youtube &&
                          ...
                          n == e.const.VIDEO_TYPE.direct &&
                              ...
                              i.parentElement.insertBefore(s, i.nextSibling),
                              (s.outerHTML = '<video id="' + l + '" class="iframe-video-preload" data-video-type="' + n + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; object-fit: cover;"></video>'),
            ...
            M = function (t, i, a, n) {
                if ("gallery" == n && (a || (i = document.getElementById(t)), !e.isEmpty(i))) {
                    ...
                    var o = function (t) {
                            t.stopPropagation(), B(i, t.target, !1);
                        },
                        l = i.classList.contains("preload");
                    if (r > 0) {
                        for (var s = 0; s < r; s++) {
                            var c = i.getElementsByClassName("ladi-gallery-view-item")[s];
                            e.isEmpty(c) || (l && B(i, c, l), c.classList.contains("play-video") && c.addEventListener("click", o));
                        }
                        i.setAttribute("data-current", 0), i.setAttribute("data-is-next", !0);
                    }
                    for (var d = i.getElementsByClassName("ladi-gallery-view-arrow"), u = 0; u < d.length; u++) r <= 1 ? d[u].classList.add("ladi-hidden") : d[u].classList.remove("ladi-hidden");
                }
            },
            V = function (t, i) {
                t.stopPropagation();
                ...
                var l = parseFloatLadiPage(t.target.getAttribute("data-index")) || 0,
                    s = null,
                    c = null;
                (parseFloatLadiPage(i.getAttribute("data-current")) || 0) > l ? ((s = "prev"), (c = "right")) : ((s = "next"), (c = "left"));
                var d = i.getAttribute("data-is-next") || "true";
                (d = "true" == d.toLowerCase()) ? l-- : l++, i.setAttribute("data-current", l), i.setAttribute("data-next-time", Date.now() + 1e3 * o), R(i, !1, s, c);
            },
            F = function () {
                        ...
                        for (var a = document.querySelectorAll("#" + t), n = 0; n < a.length; n++) {
                            ...
                            if ("true" == r.getAttribute("data-scrolled") && "true" != r.getAttribute("data-stop")) {
                                var o = i[e.runtime.device + ".option.gallery_control.autoplay"],
                                    l = i[e.runtime.device + ".option.gallery_control.autoplay_time"],
                                    s = 0;
                                if ((o && !e.isEmpty(l) && (s = l), s > 0)) {
                                    var c = r.getAttribute("data-next-time"),
                                        d = Date.now();
                                    e.isEmpty(c) && ((c = d + 1e3 * (s - 1)), r.setAttribute("data-next-time", c)), d >= c && (R(r, !0), r.setAttribute("data-next-time", d + 1e3 * s));
                                }
                            }
                        }
                });
            ...
            q = function (t, i) {
                ...
                if ("gallery" == a.type) {
                    ...
                    i.getElementsByClassName("ladi-gallery-view-arrow-left")[0].addEventListener("click", function (t) {
                        t.stopPropagation(), i.setAttribute("data-is-next", !1), i.setAttribute("data-next-time", Date.now() + 1e3 * l), R(i, !1);
                    }),
                        i.getElementsByClassName("ladi-gallery-view-arrow-right")[0].addEventListener("click", function (t) {
                            t.stopPropagation(), i.setAttribute("data-is-next", !0), i.setAttribute("data-next-time", Date.now() + 1e3 * l), R(i, !1);
                        }),
                        i.getElementsByClassName("ladi-gallery-control-arrow-left")[0].addEventListener("click", function (t) {
                            ...
                            if (!e.isEmpty(a)) {
                                ...
                                if (i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                    var r = (parseFloatLadiPage(n.width) || 0) + (parseFloatLadiPage(n.marginRight) || 0);
                                    (r += parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].style.getPropertyValue("left")) || 0) > 0 && (r = 0),
                                        i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("left", r + "px");
                                } else {
                                    var o = (parseFloatLadiPage(n.height) || 0) + (parseFloatLadiPage(n.marginBottom) || 0);
                                    (o += parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].style.getPropertyValue("top")) || 0) > 0 && (o = 0),
                                        i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", o + "px");
                                }
                        ...
                        i.getElementsByClassName("ladi-gallery-control-arrow-right")[0].addEventListener("click", function (t) {
                            ...
                            if (!e.isEmpty(a)) {
                                ...
                                if (i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || i.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) {
                                    ...
                                    s = -s + (parseFloatLadiPage(i.getElementsByClassName("ladi-gallery-control-box")[0].style.getPropertyValue("top")) || 0);
                                    var c = parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control-box")[0]).height) || 0;
                                    s < (c = (c = -(c -= parseFloatLadiPage(getComputedStyle(i.getElementsByClassName("ladi-gallery-control")[0]).height) || 0)) > 0 ? 0 : c) && (s = c),
                                        i.getElementsByClassName("ladi-gallery-control-box")[0].style.setProperty("top", s + "px");
                                }
                                i.setAttribute("data-next-time", Date.now() + 1e3 * l);
                            }
                        }),
                        i.getElementsByClassName("ladi-gallery-view")[0].addEventListener("mousedown", c),
                        i.getElementsByClassName("ladi-gallery-view")[0].addEventListener("touchstart", c),
                        i.getElementsByClassName("ladi-gallery-control")[0].addEventListener("mousedown", d),
                        i.getElementsByClassName("ladi-gallery-control")[0].addEventListener("touchstart", d);
            ...
            Y = function (t, i) {
                if ((e.isEmpty(e.runtime.timenext_carousel[t]) || !(e.runtime.timenext_carousel[t] > Date.now())) && e.isEmpty(e.runtime.current_element_mouse_down_carousel)) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        u < p && (u = p), a.getElementsByClassName("ladi-carousel-content")[0].style.setProperty("left", u + "px"), a.setAttribute("data-is-next", n), a.setAttribute("data-current", r), i || a.setAttribute("data-stop", !0);
                    }
                }
            },
            H = function (t) {
                            ...
                            if (!e.isEmpty(l)) {
                                ...
                                if (!e.isEmpty(s)) {
                                    ...
                                    if (!e.isEmpty(c) && !e.isEmpty(d)) {
                                        var u = e.generateVariantProduct(r, !0, s["option.product_variant_type"], s["option.product_variant_title"], s["option.product_variant_price"], s["option.input_tabindex"], t, !0, function (t) {
                                            U(i, a, n);
                                        });
                                        if (!e.isEmpty(u)) {
                                            var p = function (t) {
                                                e.updateProductVariantSelectOption(t, r, s, n, function () {
                                                    if (n) {
                                                        ...
                                                        for (var s = document.querySelectorAll("#POPUP_PRODUCT .ladi-element"), c = 0; c < s.length; c++) s[c].id != i && e.runtime.tmp.runLadiSaleProductKey(s[c].id, !1, !1, l, a);
                                                    } else e.runtime.tmp.generateLadiSaleProduct(!1, !0, t);
                                                });
                                            };
                                            e.showParentVisibility(l, function () {
                                                for (var t = l.clientHeight, i = t, a = l.querySelectorAll("select.ladi-form-control"), n = {}, c = 0; c < a.length; c++)
                                                    n[a[c].getAttribute("data-store-id") + "_" + a[c].getAttribute("data-product-id") + "_" + a[c].getAttribute("data-product-option-id")] = a[c].value;
                                                l.innerHTML = u;
                                                for (var d = l.querySelectorAll("select.ladi-form-control"), m = 0; m < d.length; m++) {
                                                    d[m].removeEventListener("change", p), d[m].addEventListener("change", p);
                                                    var g = n[d[m].getAttribute("data-store-id") + "_" + d[m].getAttribute("data-product-id") + "_" + d[m].getAttribute("data-product-option-id")];
                                                    if (e.isNull(g)) {
                                                ...
                                                if ((e.updateProductVariantSelectOptionFirst(r, s, l), s["option.product_variant_type"] != e.const.PRODUCT_VARIANT_TYPE.combined))
                                                    l.style.setProperty("height", "auto"), (i = l.clientHeight), l.style.removeProperty("height"), t != i && (l.style.setProperty("height", i + "px"), e.updateHeightElement(!0, l, o, t, i));
                                                else if (!e.isEmpty(r["option.product_variant_id"]))
                                                    for (var _ = 0; _ < d.length; _++) {
                                                        var f = d[_].querySelector('option[data-product-variant-id="' + r["option.product_variant_id"] + '"]');
                                                        e.isEmpty(f) || d[_].value == f.getAttribute("value") || ((d[_].value = f.getAttribute("value")), e.fireEvent(d[_], "change"));
                                                    }
                                            });
                                        }
                                    }
                ...
                if (e.isEmpty(r)) {
                    ...
                    for (l = 0; l < c.length; l++)
                        (r = e.findAncestor(c[l], "ladi-collection-item")),
                            e.isEmpty(r) && ((s = e.runtime.eventData[c[l].id]), e.isEmpty(s) || s["option.product_type"] != n["option.product_type"] || s["option.product_id"] != n["option.product_id"] || o.push(c[l]));
                } else o = r.querySelectorAll("[data-runtime-id]");
                for (l = 0; l < o.length; l++)
                    if (((s = e.runtime.eventData[o[l].id]), !e.isEmpty(s) && !e.isEmpty(s["option.product_mapping_name"]))) {
                        var d = o[l].getElementsByClassName("ladi-gallery-view")[0],
                            u = e.getOptimizeImage(a, d.clientWidth, d.clientHeight, !0, !1, !1, t);
                        u = 'url("' + u + '")';
                        for (var p = d.getElementsByClassName("ladi-gallery-view-item"), m = 0; m < p.length; m++)
                            if (u == getComputedStyle(p[m]).backgroundImage) {
                                var g = (parseFloatLadiPage(p[m].getAttribute("data-index")) || 0) + 1;
                                window.ladi(o[l].id, o[l]).index(g);
                            }
                    }
            },
            G = function (i, a, n, r, o, l) {
                ...
                if (!e.isEmpty(s)) {
                    var c = !e.isEmpty(s["option.product_mapping_name"]),
                        ...
                        m = null;
                    if (e.isEmpty(r)) {
                        if (e.isEmpty(s) || e.isEmpty(s["option.product_type"]) || e.isEmpty(s["option.product_id"]) || e.isEmpty(s["option.product_mapping_name"])) return;
                        ...
                        if (
                            ...
                            (a &&
                                (y = !(function () {
                                    for (var t = !1, i = 0; i < p.length; i++) {
                                        ...
                                        if ("form" == a.type && a["option.product_type"] == s["option.product_type"] && a["option.product_id"] == s["option.product_id"]) {
                                            t = !0;
                                            break;
                                        }
                                    }
                            ...
                            if (s["option.product_id"] != l.target.getAttribute("data-product-id")) return;
                            s["option.product_type"], s["option.product_mapping_name"];
                            var _ = e.generateVariantProduct(s, !1, null, null, null, null, !0, !0, function (t) {
                                G(i, a, n, r, o, l);
                            });
                        ...
                        if ("form" == d && s["option.is_add_to_cart"]) return (s["option.product_id"] = r.product_id), (s["option.product_variant_id"] = r.product_variant_id), void U(i, d, !0);
                        if (!c) return;
                        m = (m = e.generateProductKey(null, !0, s, !1, r.product_variant_id, r)) || "";
                    }
                    var f = null,
                        h = null,
                        v = null;
                    if ((("headline" != d && "paragraph" != d) || window.ladi(i).value(m), "image" == d)) {
                        if (((f = document.getElementById(i)), e.isEmpty(f))) return;
                        (v = e.getOptimizeImage(m, f.clientWidth, f.clientHeight, !0, !1, !1, t)), (h = "style_add_to_cart_image_" + i);
                        var E = "";
                        e.isEmpty(v)
                            ? (E = "#" + i + "  > .ladi-image > .ladi-image-background {background-image: none;}")
                            : ((E = "#" + i + '  > .ladi-image > .ladi-image-background {background-image: url("' + v + '");}'), n && j(f, m, s)),
                            e.createStyleElement(h, E);
                    }
                    if ("gallery" == d) {
                        if (!e.isArray(m)) return;
                        if (((f = document.getElementById(i)), e.isEmpty(f))) return;
                        for (var P = f.getElementsByClassName("ladi-gallery-view")[0], L = f.getElementsByClassName("ladi-gallery-view-item"); L.length < m.length; ) {
                            var A = e.createTmpElement("div", '<div class="ladi-gallery-view-item" data-index="' + L.length + '"></div>', null, !0);
                            f.getElementsByClassName("ladi-gallery-view")[0].appendChild(A);
                        }
                        for (; L.length > m.length; ) L[L.length - 1].parentElement.removeChild(L[L.length - 1]);
                        for (
                            ...
                            var b = e.createTmpElement("div", '<div class="ladi-gallery-control-item" data-index="' + w.length + '"></div>', null, !0);
                            b.addEventListener("click", S), f.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(b);
                        }
                        for (; w.length > m.length; ) w[w.length - 1].parentElement.removeChild(w[w.length - 1]);
                        h = "style_add_to_cart_gallery_" + i;
                        var T = "";
                        m.length <= 1 &&
                            ((T += "#" + i + " .ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow {display: none;}"),
                            (T += "#" + i + " > .ladi-gallery > .ladi-gallery-view {height: 100%;}"),
                            (T += "#" + i + " > .ladi-gallery > .ladi-gallery-control {display: none;}"));
                        var C = f.getElementsByClassName("ladi-gallery-control-item")[0];
                        if (
                            (m.forEach(function (a, n) {
                                (v = e.getOptimizeImage(a.src, P.clientWidth, P.clientHeight, !0, !1, !1, t)),
                                    (T += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + v + '");}'),
                                    (v = e.getOptimizeImage(a.src, C.clientWidth, C.clientHeight, !0, !1, !1, t)),
                                    (T += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + v + '");}');
                            }),
                            ...
                            f.removeAttribute("data-stop"), f.removeAttribute("data-current"), f.removeAttribute("data-is-next"), f.removeAttribute("data-next-time");
                            ...
                            var N = r.src;
                            e.isEmpty(N) && (N = e.isObject(o.product.image) ? o.product.image.src : N),
                                (N = "https://" + e.const.STATIC_W_DOMAIN + "/" + N),
                                (N = 'url("' + (N = e.getOptimizeImage(N, P.clientWidth, P.clientHeight, !0, !1, !1, t)) + '")');
                            e.runTimeout(function () {
                                for (var t = f.getElementsByClassName("ladi-gallery-view-item"), e = 0; e < t.length; e++)
                                    if (N == getComputedStyle(t[e]).backgroundImage) {
                                        var i = (parseFloatLadiPage(t[e].getAttribute("data-index")) || 0) + 1;
        ...
        (this.runtime.tmp.generateLadiSaleProduct = function (t, i, a) {
                                                                ...
                                                                if (!e.isEmpty(_)) {
                                                                    ...
                                                                    if (y["option.product_variant_type"] == e.const.PRODUCT_VARIANT_TYPE.combobox) {
                                                                        ...
                                                                        if (e.isString(E.option_ids))
                                                                            for (var P = E.option_ids.split("/"), L = 0; L < P.length; L++)
            ...
            (this.runtime.tmp.runOptionAction = N),
            (this.runtime.tmp.runOptionHover = k),
            (this.runtime.tmp.runTrackingAnalytics = O),
            (this.runtime.tmp.runLadiSaleProductKey = G),
            (this.runtime.tmp.eventClickGalleryControlItem = V),
            (this.runtime.tmp.runGallery = M),
            (this.runtime.tmp.setGalleryStart = q),
            (this.runtime.tmp.updateImageGalleryProduct = j),
            (this.runtime.tmp.runOptionCountdown = D),
            (this.runtime.tmp.runOptionCountdownItem = x),
            ...
            p.forEach(function (i) {
                ...
                e.isEmpty(r)
                    ? (!(function (t, i, a, n, r, o) {
                      ...
                      k(null, i, n.type, n["option.data_hover"]),
                      ...
                      D(i, null, n.type, n["option.countdown_type"], n["option.countdown_minute"], n["option.countdown_daily_start"], n["option.countdown_daily_end"], n["option.countdown_endtime"]),
                      x(i, null, n.type, n["option.countdown_item_type"]),
                      (function (t, i, a, n) {
                          if ("section" == i) {
                                              ...
                                              if (!e.isEmpty(a) && a["option.is_add_to_cart"]) {
                                                  ...
                                                  if (!(e.isEmpty(n) || e.isEmpty(n.store_info) || e.isEmpty(n.product))) {
                                                      ...
                                                      if (-1 != o) {
                                                          ...
                                                          s <= 0 && ((s = 0), (0 == n.product.variants[o].inventory_checked || l > 0) && (s = 1)),
                                                              1 == n.product.variants[o].inventory_checked && (s > l || 0 == l) && (s = l),
                                                              s <= 0 && (s = 1),
                                                              (i.target.value = s);
                                                      }
                                                  }
            ...
            (function () {
                var i,
                    ...
                    h = ["name", "email", "phone", "address", "ward", "district", "state", "country"],
                    E = ["email", "phone"],
                    P = e.copy(e.runtime.list_set_value_name_country).reverse(),
                    L = function (t, i) {
                    ...
                    A = function (t, i, a) {
                        ...
                        for (l = 0; l < y.length; l++)
                            if (!i || y[l].name == a) {
                                ...
                                if (!e.isEmpty(c))
                                    try {
                                        if (!new RegExp("^" + y[l].pattern + "$", y[l].pattern_flag).test(c)) {
                    ...
                    w = function (t, i) {
                        ...
                        for (var v = 0; v < a.length; v++) {
                            (d = a[v].getAttribute("name")), a[v].required && -1 == g.indexOf(d) && g.push(d);
                            var E = null;
                            if ("INPUT" == a[v].tagName) {
                                E = a[v].getAttribute("type").trim().toLowerCase();
                                var L = a[v].getAttribute("pattern"),
                                ...
                                if (
                                    ("email" == E
                                        ...
                                        : e.isEmpty(L) || y.push({ name: d, pattern: L, title: e.isEmpty(A) ? e.const.LANG.FORM_INPUT_TEXT_REGEX : A }),
                                    "checkbox" == E)
                                ) {
                            ...
                            (n[d] = a[v].value),
                                a[v].hasAttribute("data-path-file") && ((n[d] = JSON.parse(a[v].getAttribute("data-path-file"))), (l[d] = !0)),
                                "coupon" == d && "INPUT" == a[v].tagName && "text" == E && "true" == a[v].getAttribute("data-replace-coupon") && (n[d] = e.runtime.tmp.current_use_coupon || "");
                        }
                        i ||
                    ...
                    S = function (t, i, a) {
                        ...
                        e.isEmpty(m) || (r.captcha_token = m), e.isEmpty(u) || (r.total_revenue = u), e.isEmpty(e.runtime.time_zone) || (r.time_zone = e.runtime.time_zone);
                        ...
                        if (
                            ...
                            e.isNull(p) || r.form_data.push({ name: "cart_products", value: p, is_ladipage: !0 }), e.isEmpty(u) || r.form_data.push({ name: "cart_revenue", value: u, is_ladipage: !0 });
                    ...
                    k = function (i, a, r, o, h) {
                        (_ = e.getURLSearchParams(window.location.search)), (n = {}), (l = {}), (s = {}), (c = []), (d = null), (u = null), (p = null), (m = a.captcha_token), (g = []), (y = []);
                        var v = i.getElementsByClassName("ladi-form")[0];
                        if (!e.isEmpty(v)) {
                            var E = e.runtime.eventData[i.id];
                            if (!e.isEmpty(E)) {
                                if (E["option.is_add_to_cart"]) return;
                                (d = E["option.form_config_id"]), (u = parseFloatLadiPage(E["option.form_purchase_value"]) || 0), e.runtime.shopping && ((u = e.getCartCheckoutPrice(u)), (p = e.getCartProducts()));
                            }
                            if (r) {
                                if (e.isEmpty(o)) return;
                                if ((w(v, r), !A(v, r, h))) return;
                                return a.captcha && !e.isEmpty(E) && E["option.form_captcha"] && e.isObject(e.runtime.tmp.google_captcha)
                                    ? void (
                                          window.grecaptcha &&
                                    ...
                                    : void S(r, o, function (t) {
                                          ...
                                          (!e.isEmpty(e.runtime.tmp.capture_form_data_last[o + "_" + h]) && e.equals(e.runtime.tmp.capture_form_data_last[o + "_" + h], a)) ||
                                              ((e.runtime.tmp.capture_form_data_last[o + "_" + h] = a), e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, { "Content-Type": "application/json" }));
                                      });
                            }
                            if (e.isEmpty(E)) I(v, o);
                            else if (
                                ...
                                var P = function () {
                                        ...
                                        var t = v.querySelector(".ladi-button > .ladi-element > .ladi-headline");
                                        e.isNull(e.runtime.tmp.form_button_headline[i.id]) && (e.runtime.tmp.form_button_headline[i.id] = t.innerHTML), (t.innerHTML = "● ● ●");
                                    },
                                    L = function () {
                                        delete e.runtime.tmp.form_sending[i.id], (v.querySelector(".ladi-button > .ladi-element > .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]);
                                    };
                                if (a.captcha && !e.isEmpty(E) && E["option.form_captcha"] && e.isObject(e.runtime.tmp.google_captcha))
                                    window.grecaptcha
                                        ? (P(),
                                          window.grecaptcha.ready(function () {
                                              try {
                                    ...
                                    var T = E["option.form_send_ladipage"],
                                        D = E["option.form_api_data"],
                                        x = E["option.thankyou_type"],
                                        R = E["option.thankyou_value"],
                                        B = E["option.deeplink_value"],
                                        M = E["option.form_auto_funnel"],
                                        V = E["option.form_thankyou_funnel"];
                                    if (e.isEmpty(d)) I(v, o);
                                            ...
                                            W = function (a, r, o, l) {
                                                if (o.readyState == XMLHttpRequest.DONE) {
                                                    if (l == e.const.API_FORM_DATA) {
                                                        ...
                                                        200 == c.code ? F++ : (q++, (j = !1));
                                                    } else 200 == r || 201 == r ? F++ : e.getElementAHref(l).host == e.const.DOMAIN_GOOGLE_DOCS ? F++ : q++;
                                                    F + q == Y.length &&
                                                        (j && !H && F >= 1
                                                            ? ((H = !0),
                                                              (function (t, i) {
                                                                  ...
                                                                  (a = e.runTimeout(r, 3e3)), O("FormSubmit", { total_revenue: t }, r);
                                                              })(u, function (a, r) {
                                                                  ...
                                                                  e.isEmpty(o) || ((o = e.findAncestor(o, "ladi-element")), e.runRemovePopup(o.id, t)),
                                                                      (function () {
                                                                          var t = 0;
                                                                          if (!e.runtime.isDesktop && !e.isEmpty(B)) {
                                                                              t = 1e3;
                                                                              var i = e.convertDataReplaceStr(B, !0, null, !1, s);
                                                                              window.ladi(i).open_url();
                                                                          }
                                                                          if (!V || e.isEmpty(C)) {
                                                                              if (
                                                                                  (x == e.const.FORM_THANKYOU_TYPE.default && (e.isEmpty(R) || e.showMessage(R, s)),
                                                                                  x == e.const.FORM_THANKYOU_TYPE.popup && (M && e.setDataReplaceElement(!1, !1, s, R), window.ladi(R).show()),
                                                                                  x == e.const.FORM_THANKYOU_TYPE.url && !e.isEmpty(R))
                                                                              ) {
                                                                                  var a = window.ladi(R).get_url(n, M);
                                                                                  e.runTimeout(function () {
                                                                                      window.ladi(a).open_url();
                                                                                  }, t);
                                                                              }
                                                                          } else {
                                                                              var r = window.ladi(C).get_url(n, M);
                                                                              e.runTimeout(function () {
                                                            ...
                                                            : !U && q >= 1 && ((U = !0), e.showMessage(e.const.LANG.FORM_SEND_DATA_ERROR), G(!1)));
                                                }
                                            },
                                            z = function (t) {
                                                Y.push({ url: e.const.API_FORM_DATA, data: JSON.stringify(t), async: !0, headers: { "Content-Type": "application/json" }, callback: W });
                                            };
                                        T && S(r, o, z),
                                            e.isArray(D) &&
                                                D.forEach(function (t) {
                                                    if (!e.isEmpty(t.api_url) && e.isArray(t.custom_fields)) {
                                                        ...
                                                        t.custom_fields.forEach(function (t) {
                                                            if ((e.runtime.shopping && ("cart_products" == t.ladi_name && (n = t.name), "cart_revenue" == t.ladi_name && (r = t.name)), !l[t.ladi_name])) {
                                                                var i = s[t.ladi_name];
                                                                e.isNull(i) || (e.isArray(i) ? (0 == i.length ? (a[t.name] = "") : (a[t.name] = JSON.stringify(i))) : (a[t.name] = i));
                                                            }
                                                        }),
                                                            e.isEmpty(n) || e.isNull(p) || (a[n] = JSON.stringify(p)),
                                                        ...
                                                        m == e.const.CONTENT_TYPE.form_urlencoded &&
                                                            ...
                                                            (d = Object.keys(a)
                                                                ...
                                                                .join("&"))),
                                                            m == e.const.CONTENT_TYPE.json && ((o["Content-Type"] = "application/json"), (d = JSON.stringify(a))),
                                                            m == e.const.CONTENT_TYPE.form_data &&
                                                                ((d = new FormData()),
                                                                Object.keys(a).forEach(function (t) {
                                                                    d.append(t, a[t]);
                                                                })),
                                                            Y.push({ url: t.api_url, data: d, async: !0, headers: o, callback: W });
                                                    }
                                                }),
                                            Y.length > 0 ? P() : T ? I(v, o) : (P(), S(r, o, z)),
                    ...
                    x = function (t) {
                        ...
                        if (!e.isEmpty(i)) {
                            ...
                            if (-1 == n) {
                                ...
                                e.isEmpty(l) || !l["option.form_auto_capture"] || e.isEmpty(l["option.form_config_id"]) || (o = L(i.id, l["option.form_config_id"])), k(i, { captcha: !0 }, !1, o);
                            } else {
                                var s = a[n].querySelectorAll('[type="checkbox"]');
                                if (s.length > 0) {
                                    s[0].setAttribute("required", "required");
                                    for (var c = 0; c < s.length; c++) s[c].removeEventListener("change", D), s[c].addEventListener("change", D);
                    ...
                    R = function (t, i, a, n) {
                        ...
                        if (!e.isEmpty(r)) {
                            ...
                            if (
                                ...
                                var l = function () {
                                    var r = e.generateVariantProduct(a, !1, null, null, null, null, !0, !0, l);
                                    if (e.isEmpty(r) || e.isEmpty(r.store_info) || e.isEmpty(r.product))
                                        ...
                                        if (-1 != s) {
                                            ...
                                            var p = r.product.name,
                                                ...
                                                _ = e.isEmpty(r.product.variants[s].src) ? "" : r.product.variants[s].src;
                                            (_ = e.isEmpty(_) && e.isObject(r.product.image) ? r.product.image.src : _), e.isEmpty(_) || (_ = "https://" + e.const.STATIC_W_DOMAIN + "/" + _);
                                            ...
                                            -1 == f &&
                                                ...
                                                e.runtime.tmp.cart.push({
                                                    ...
                                                    image: _,
                                                    quantity: 0,
                                                    inventory_checked: r.product.variants[s].inventory_checked,
                                                    available_quantity: y,
                                                    currency: r.store_info.currency,
                                                }),
                                                (f = e.runtime.tmp.cart.length - 1));
                                            var v = o.querySelector('input[name="quantity"]');
                                            if (e.isEmpty(v) || e.isEmpty(v.value)) e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED);
                                            else {
                                                var E = parseInt(v.value) || 0;
                                                if (0 == E) e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED);
                                                else {
                                                    var P = !1;
                                                    if ((1 == r.product.variants[s].inventory_checked && e.runtime.tmp.cart[f].quantity + E > y && ((E = y - e.runtime.tmp.cart[f].quantity), y > 0 && (P = !0)), P || (E <= 0 && y > 0)))
                                                        e.showMessage(e.const.LANG.ADD_TO_CART_MAX_QUANTITY, { max: y }, function () {
                                                            var i = t.target;
                                                            ...
                                                            e.isEmpty(a) ||
                                                                ...
                                                                (a["option.data_action"].type == e.const.DATA_ACTION_TYPE.popup_cart && window.ladi("POPUP_CART").show(),
                                                                a["option.data_action"].type == e.const.DATA_ACTION_TYPE.popup_checkout && window.ladi("POPUP_CHECKOUT").show());
                                                        });
                                                    else if (E > 0) {
                                                        var L = function () {
                                                            (e.runtime.tmp.cart[f].quantity += E),
                                                                e.addCartCookie(
                                                                    r.store_info.id,
                                                                    { type: "LP", product_variant_id: c, quantity: E },
                                                                    n,
                                                                    function (t) {
                                                                        (e.runtime.tmp.cart[f].quantity -= E), h && e.runtime.tmp.cart.splice(f, 1), e.showMessage(t.message);
                                                                    },
                                                                    function () {
                                                        ...
                                                        if (e.isEmpty(window.ladi("_cart_token").get_cookie()))
                                                            if (e.runtime.tmp.is_click_add_to_cart) {
                                                                var A = function () {
                                                                    e.runTimeout(function () {
                                                                        if (e.runtime.tmp.is_click_add_to_cart) return A();
                                                                        l();
                                                                    }, 100);
                                                                };
                                                                A();
                                                            } else (e.runtime.tmp.is_click_add_to_cart = !0), L();
                                                        else L();
                ...
                var q = 0,
                    Y = !1,
                    H = function (t) {
                        for (var n = a[q].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), r = 0; r < n.length; r++) {
                            var o = F[t];
                            if (!e.isEmpty(o))
                ...
                for (q = 0; q < a.length; q++) {
                    a[q].onsubmit = x;
                    for (var U = e.findAncestor(a[q], "ladi-element"), j = a[q].getElementsByClassName("ladi-button"), G = 0; G < j.length; G++) {
                        var W = a[q].getElementsByClassName("ladi-button")[G];
                        if (!e.isEmpty(W)) {
                            var z = e.findAncestor(W, "ladi-element");
                            e.isEmpty(U) || e.isEmpty(e.runtime.eventData[U.id]) || !e.runtime.eventData[U.id]["option.is_add_to_cart"] ? z.addEventListener("click", M) : (z.setAttribute("data-click", !1), z.addEventListener("click", B));
                        }
                    }
                    var X = a[q].querySelector('[data-is-select-country="true"][name="country"]');
                    if (!e.isEmpty(X) && -1 != ["TH", "MY"].indexOf(X.value.split(":")[0])) {
                        var K = a[q].querySelector('select[data-is-select-country="true"][name="ward"]');
                        e.isEmpty(K) || K.removeAttribute("required");
                    }
                    for (var J = a[q].querySelectorAll("[tabindex]"), Z = 0, $ = 0; $ < J.length; $++) {
                        var Q = parseInt(J[$].getAttribute("tabindex")) || 0;
                        Q > Z && (Z = Q), J[$].setAttribute("tabindex", e.runtime.tabindexForm + Q);
                    }
                    e.runtime.tabindexForm += Z;
                    for (var tt = 0; tt < E.length; tt++) {
                        var et = a[q].querySelector('.ladi-element .ladi-form-item-container input[name="' + E[tt] + '"]');
                        e.isEmpty(et) || et.addEventListener("focusout", V);
                    }
                }
                var it = function (t, i) {
                    for (Y = i, q = 0; q < a.length; q++) {
                        var n = e.findAncestor(a[q], "ladi-element");
                        !e.isEmpty(e.runtime.eventData[n.id]) && e.runtime.eventData[n.id]["option.form_auto_complete"] && t.forEach(H);
                    }
                };
                ...
                e.runtime.tmp.runAfterLocation.push(function () {
                    ...
                    for (q = 0; q < a.length; q++) {
                        var c = a[q].querySelectorAll('.ladi-element .ladi-form-item-container [name="state"]'),
                            d = 0,
                            u = null;
                        ...
                        var m = a[q].querySelectorAll('.ladi-element .ladi-form-item-container [name="district"]');
                    ...
                    (e.runtime.tmp.buttonAddToCartClick = R);
            })(),
            (function () {
                for (
                    ...
                    if ("countdown" == e.runtime.eventData[t].type)
                        for (var i = document.querySelectorAll("#" + t), a = 0; a < i.length; a++) {
                            var n = i[a],
                                ...
                                l = 0,
                                s = Date.now();
                            if (n.hasAttribute("data-date-start") || n.hasAttribute("data-date-end")) (o = parseFloatLadiPage(n.getAttribute("data-date-start")) || 0), (l = parseFloatLadiPage(n.getAttribute("data-date-end")) || 0);
                            else {
                                ...
                                if ((r == e.const.COUNTDOWN_TYPE.endtime && (l = parseInt(n.getAttribute("data-endtime")) || 0), r == e.const.COUNTDOWN_TYPE.daily)) {
                                    ...
                                    if (!e.isEmpty(d) && !e.isEmpty(u)) {
                                        ...
                                        (o = new Date(p + " " + d).getTime()), (l = new Date(p + " " + u).getTime());
                                    }
                                }
                                n.setAttribute("data-date-start", o), n.setAttribute("data-date-end", l);
                            }
                            if (o > s) return;
                            var m = l - s;
                            m < 0 && (m = 0);
                            for (var g = e.getCountdownTime(m), y = n.querySelectorAll("[data-item-type]"), _ = 0; _ < y.length; _++)
                                y[_].querySelectorAll(".ladi-countdown-text span")[0].textContent = g[y[_].getAttribute("data-item-type")];
                        }
                });
            })(),
            ...
            (e.runtime.interval_gallery = e.runInterval(F, 1e3)),
            p.forEach(function (t) {
                var i = e.runtime.eventData[t];
                if ("carousel" == i.type) {
                    var a = document.getElementById(t);
                        ...
                        if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled") && "true" != a.getAttribute("data-stop")) {
                            ...
                            if ((n && !e.isEmpty(r) && (o = r), o > 0)) {
                                var l = a.getAttribute("data-next-time"),
                                    s = Date.now();
                                e.isEmpty(l) && ((l = s + 1e3 * (o - 1)), a.setAttribute("data-next-time", l)), s >= l && (Y(t, !0), a.setAttribute("data-next-time", s + 1e3 * o));
                            }
                        }
                    }
                });
            ...
            (function () {
                            ...
                            if (!e.isEmpty(c)) {
                                ...
                                if (!e.isEmpty(d) && !e.isEmpty(d["option.data_submit_form_id"])) {
                                    ...
                                    if (!e.isEmpty(u) && u["option.is_form_coupon"]) {
                                        ...
                                        if (!e.isEmpty(p)) {
                                            p.addEventListener("change", n), p.addEventListener("input", r);
                                            var m = document.querySelector("#" + d["option.data_submit_form_id"] + ' .ladi-form-item input[name="coupon"]');
                                            e.isEmpty(m) || m.setAttribute("data-replace-coupon", !0);
                                        }
                                        e.runtime.tmp.list_form_checkout.push(d["option.data_submit_form_id"]);
                                    }
                                }
                            }
                        }
                ...
                for (
                    ...
                    for (var _ = document.querySelectorAll("#" + e.runtime.tmp.list_form_checkout[y] + " .ladi-form-item input.ladi-form-control"), f = 0; f < _.length; f++)
                        -1 != t.indexOf(_[f].getAttribute("name")) && (_[f].addEventListener("change", g), _[f].addEventListener("input", g));
            })(),
            (function () {
                p.forEach(function (t) {
                    var i = e.runtime.eventData[t];
        ...
        for (
            var m = function (t) {
                    ...
                    if (
                        ...
                        o.isEmpty(i) || i[a + ".option.sticky_position"] != o.const.POSITION_TYPE.top || (e = !0);
                    }
                    return e;
                },
                g = n - a,
    ...
    (LadiPageScriptV2.prototype.runStoryPage = function () {
        ...
        if (this.isObject(e)) {
            ...
            if (!this.isEmpty(i)) {
                ...
                var n = document.querySelectorAll('.ladi-section:not([id="' + this.runtime.builder_section_popup_id + '"])');
                if (0 != n.length) {
                    ...
                    for (
                        ...
                        var s = document.createElement("div");
                        (s.className = "ladi-story-page-progress-bar-item"), o(s, n[l]), a.appendChild(s), 0 == l && (r = s);
                    }
    ...
    (LadiPageScriptV2.prototype.reloadLazyload = function (t) {
        var e = this;
        if ((e instanceof LadiPageScriptV2 || (e = LadiPageScript), !t || !e.isObject(e.runtime.story_page))) {
            for (var i = document.getElementsByClassName("ladi-lazyload"), a = [], n = 0; n < i.length; n++) {
                var r = e.getElementBoundingClientRect(i[n]).y + window.scrollY;
                window.scrollY + e.getHeightDevice() > r && r + i[n].offsetHeight > window.scrollY && a.push(i[n]);
            }
            a.forEach(function (t) {
                t.classList.remove("ladi-lazyload");
            });
            for (var o = document.querySelectorAll(".ladi-gallery .ladi-gallery-view-item.selected:not(.ladi-lazyload)"), l = 0; l < o.length; l++)
                if (e.isEmpty(o[l].getAttribute("data-lazyload"))) {
                    o[l].setAttribute("data-lazyload", !0);
                    for (var s = o[l].parentElement.getElementsByClassName("ladi-lazyload"); s.length > 0; ) s[0].classList.remove("ladi-lazyload");
                }
        }
    }),
    (LadiPageScriptV2.prototype.documentLoaded = function () {
        ...
        if ((t.resetViewport(), t.runEventScroll(), !t.isEmpty(t.runtime.tracking_global_url))) {
            var u = !1,
                p = window;
            t.isObject(t.runtime.story_page) && (p = document.getElementsByClassName("ladi-wraper")[0]);
            var m = function () {
                u || ((u = !0), t.loadScript(t.runtime.tracking_global_url + "?v=" + Date.now()), p.removeEventListener("scroll", m), document.removeEventListener("mousemove", m), document.removeEventListener("touchstart", m));
            };
            p.addEventListener("scroll", m), document.addEventListener("mousemove", m), document.addEventListener("touchstart", m), t.runTimeout(m, t.runtime.tracking_global_delay);
        }
    }),
            ...
            if (
                (Object.keys(e.runtime.eventData).forEach(function (t) {
                    var a = e.runtime.eventData[t],
                        ...
                        d = [];
                    d = "gallery" == a.type ? document.querySelectorAll("#" + t) : [(l = document.getElementById(t))];
                    for (var u = 0; u < d.length; u++)
                        if (((l = d[u]), !e.isEmpty(l))) {
                            var p = "gallery" == a.type ? l.getAttribute("data-runtime-id") : l.getAttribute("id");
                            if (-1 != c.indexOf(p)) {
                                var m = !1;
                                "section" == a.type
                                    ? ((n = l.offsetTop),
                                      ((window.scrollY >= n && window.scrollY <= n + l.offsetHeight) ||
                                          (window.scrollY + e.getHeightDevice() >= n && window.scrollY + e.getHeightDevice() <= n + l.offsetHeight) ||
                                          (n >= window.scrollY && window.scrollY + e.getHeightDevice() >= n)) &&
                                          (m = !0))
                                    : ((n = e.getElementBoundingClientRect(l).y + window.scrollY),
                                      ((window.scrollY >= n && window.scrollY <= n + l.offsetHeight) ||
                                          (window.scrollY + e.getHeightDevice(!0) >= n && window.scrollY + e.getHeightDevice(!0) <= n + l.offsetHeight) ||
                                          (n >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= n)) &&
                                          (m = !0)),
                                    m && ((o = e.runtime.list_scroll_func[p]), delete e.runtime.list_scroll_func[p], o());
                            }
                        }
                    var g = a[e.runtime.device + ".style.animation-name"];
                    if (!e.isEmpty(g) && ((l = document.getElementById(t)), !e.isEmpty(l) && !l.classList.contains("ladi-animation"))) {
                        var y = parseFloatLadiPage(a[e.runtime.device + ".style.animation-delay"]) || 0;
                        n = e.getElementBoundingClientRect(l).y + window.scrollY;
                        var _ =
                            (window.scrollY >= n && window.scrollY <= n + l.offsetHeight) ||
                            (window.scrollY + e.getHeightDevice(!0) >= n && window.scrollY + e.getHeightDevice(!0) <= n + l.offsetHeight) ||
                            (n >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= n);
                        e.runtime.tmp.isFirstScroll && y > 0 && !_ && l.classList.add("ladi-animation-hidden"),
                            _ &&
                    ...
                    if (e.isEmpty(i) || -1 != r.indexOf(t)) {
                        ...
                        if (
                            (a[e.runtime.device + ".option.sticky"] &&
                                ...
                                (h = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_top"])),
                                (v = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_bottom"]))),
                            !e.isEmpty(f))
                        ) {
                            var E = document.getElementById(t);
                            if (!e.isEmpty(E) && -1 != ["default", "top", "bottom"].indexOf(f)) {
                                var P = e.getElementBoundingClientRect(E),
                                    L = E.getAttribute("data-top"),
                                    A = E.getAttribute("data-left");
                                e.isEmpty(L) ? (E.setAttribute("data-top", P.y + window.scrollY), (L = P.y)) : (L = parseFloatLadiPage(L)),
                                    e.isEmpty(A) ? (E.setAttribute("data-left", P.x + window.scrollX), (A = P.x)) : (A = parseFloatLadiPage(A));
                                var w = null,
                                    S = null;
                                if (
                                    ("default" == f &&
                                        (h > L - window.scrollY ? ((w = h + "px"), (S = A + "px")) : e.getHeightDevice() - v - E.clientHeight < L - window.scrollY && ((w = "calc(100% - " + (v + E.clientHeight) + "px)"), (S = A + "px"))),
                                    "top" == f && (h > L - window.scrollY || e.getHeightDevice() - 0 < L - window.scrollY) && ((w = h + "px"), (S = A + "px")),
                                    "bottom" == f && (e.getHeightDevice() - v - E.clientHeight < L - window.scrollY || 0 > L + E.clientHeight - window.scrollY) && ((w = "calc(100% - " + (v + E.clientHeight) + "px)"), (S = A + "px")),
                                    e.isEmpty(w) || e.isEmpty(S))
                                )
                                    E.style.removeProperty("top"), E.style.removeProperty("left"), E.style.removeProperty("width"), E.style.removeProperty("position"), E.style.removeProperty("z-index");
                                else if (
                                    (E.style.setProperty("top", w),
                                    E.style.setProperty("left", S),
                                    "section" == a.type && (e.runtime.isMobileOnly ? E.style.setProperty("width", document.getElementsByClassName("ladi-wraper")[0].clientWidth + "px") : s && E.style.setProperty("width", "100%")),
                                    E.style.setProperty("position", "fixed"),
                                    E.style.setProperty("z-index", "90000050"),
                                    !E.hasAttribute("data-sticky"))
                                ) {
                                    E.setAttribute("data-sticky", !0), E.classList.contains("ladi-animation-hidden") && (E.classList.remove("ladi-animation-hidden"), E.classList.add("ladi-animation"));
                                    for (var b = E.getElementsByClassName("ladi-animation-hidden"); b.length > 0; ) b[0].classList.add("ladi-animation"), b[0].classList.remove("ladi-animation-hidden");
                                    E.classList.remove("ladi-lazyload");
                                    for (var T = E.getElementsByClassName("ladi-lazyload"); T.length > 0; ) T[0].classList.remove("ladi-lazyload");
                                }
                            }
                        }
                    }
                    if ("popup" == a.type) {
                        ...
                        e.isEmpty(a["option.popup_welcome_page_scroll_to"]) ||
                            ((l = document.getElementById(a["option.popup_welcome_page_scroll_to"])),
                            !e.isEmpty(l) &&
                                l.offsetHeight > 0 &&
                                ((n = l.offsetTop),
                                ((window.scrollY >= n && window.scrollY <= n + l.offsetHeight) ||
        ...
        if (!o.isEmpty(e)) {
            ...
            if (!n || (!o.isEmpty(s) && o.isObject(o.runtime.eventData) && !o.isEmpty(o.runtime.eventData[e]))) {
                ...
                i == o.const.POSITION_TYPE.default
                    ? ((l += "#" + o.runtime.backdrop_popup_id + " { display: block !important; " + a + "}"), s.setAttribute("data-popup-backdrop", !0), u(), (this.runtime.tmp.current_default_popup_id = e))
                ...
                if (t) f();
                    ...
                    o.runTimeout(function () {
                        "none" == getComputedStyle(s).display ? ((d -= 100), f()) : o.runShowPopup(!0, e, i, a, n, r);
                    }, 100);
                }
            }
        }
        ...
        if (this.runtime.isClient && !this.isEmpty(t)) {
            ...
            if (
                ...
                var u = null,
                    p = null;
                if (
                    (this.isEmpty(s) || this.isEmpty(c) || (((u = {}).value = s), (u.currency = c)),
                    this.isObject(window.ladi_conversion_api) && this.isObject(window.ladi_conversion_api.facebook) && this.isArray(window.ladi_conversion_api.facebook.pixels))
                ) {
                    p = { eventID: "ladi." + Date.now() + "." + (Math.floor(9e10 * Math.random()) + 1e10) };
                }
                if ((window.fbq(d, n, u, p), this.runtime.shopping && e)) {
                    var m = this.getCartProducts();
                    this.isNull(m) || (this.isObject(p) || (p = {}), (p.cart_products = m));
                }
                this.runConversionApi("facebook", "events", [{ key: d, name: n, custom_data: u, data: p }]);
            }
            if (this.isFunction(window.gtag) && (this.isEmpty(r) || this.isEmpty(o) || window.gtag("event", "conversion", { send_to: "AW-" + r + "/" + o }), !this.isEmpty(n))) {
                var g = "";
                g = "section" == a ? "LadiPageSection" : "popup" == a ? "LadiPagePopup" : "form" == a ? "LadiPageConversion" : "LadiPageClick";
                var y = LadiPageApp[i.type + this.const.APP_RUNTIME_PREFIX];
                if (!this.isEmpty(y)) {
                    var _ = y(i, this.runtime.isClient);
                    this.isFunction(_.getEventTrackingCategory) && (g = y(i, this.runtime.isClient).getEventTrackingCategory());
                }
                var f = { event_category: g, event_label: window.location.host + window.location.pathname };
                this.isEmpty(s) || this.isEmpty(c) || ((f.value = s), (f.currency = c)), window.gtag("event", n, f);
            }
            ...
            var u = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE,
                ...
                g = function (t, e, i, a, n, o) {
                    if (
                        ...
                        var s = function (e) {
                            r.updateProductVariantSelectOption(e, i, a, !1, function () {
                                ...
                                if (!r.isEmpty(l)) {
                                    ...
                                    if (!r.isEmpty(s))
                                        for (var c = s.querySelectorAll('[data-variant="true"]'), d = 0; d < c.length; d++)
                                            if (c[d].id != l.id) {
                                                var u = r.runtime.eventData[c[d].id],
                                                    p = null;
                                                if (u["option.product_variant_type"] == r.const.PRODUCT_VARIANT_TYPE.combobox) {
                                                    var m = n.variants[a];
                                                    if (r.isObject(m) && r.isString(m.option_ids))
                                                        for (var g = m.option_ids.split("/"), y = 0; y < g.length; y++)
                                                            (p = c[d].querySelector('select[data-product-option-id="' + g[y] + '"]')), r.isEmpty(p) || (p.value = m["option" + (y + 1)]);
                                                }
                                                if (u["option.product_variant_type"] == r.const.PRODUCT_VARIANT_TYPE.combined) {
                                                    if (((p = c[d].querySelector("select.ladi-form-control")), !r.isEmpty(i))) {
                                                        var _ = p.querySelector('option[data-product-variant-id="' + i + '"]');
                        ...
                        r.showParentVisibility(e, function () {
                            for (var t = e.clientHeight, n = t, o = e.querySelectorAll("select.ladi-form-control"), c = {}, d = 0; d < o.length; d++)
                                c[o[d].getAttribute("data-store-id") + "_" + o[d].getAttribute("data-product-id") + "_" + o[d].getAttribute("data-product-option-id")] = o[d].value;
                            e.innerHTML = l;
                            for (var u = e.querySelectorAll("select.ladi-form-control"), p = 0; p < u.length; p++) {
                                u[p].removeEventListener("change", s), u[p].addEventListener("change", s);
                                var m = c[u[p].getAttribute("data-store-id") + "_" + u[p].getAttribute("data-product-id") + "_" + u[p].getAttribute("data-product-option-id")];
                                if (r.isNull(m)) {
                            ...
                            if (
                                ...
                                a["option.product_variant_type"] != r.const.PRODUCT_VARIANT_TYPE.combined && (e.style.setProperty("height", "auto"), (n = e.clientHeight), e.style.removeProperty("height"), t != n))
                            ) {
                                e.style.setProperty("height", n + "px");
                                var y = r.findAncestor(e, "ladi-form");
                                r.isEmpty(y) || ((y = r.findAncestor(y, "ladi-element")), r.updateHeightElement(!0, e, y, t, n));
                            }
                        });
                    }
                                ...
                                if (!r.isEmpty(t.target.value)) {
                                    ...
                                    if (!(r.isEmpty(e) || r.isEmpty(e.store_info) || r.isEmpty(e.product))) {
                                        ...
                                        if (-1 != o) {
                                            ...
                                            s <= 0 && ((s = 0), (0 == e.product.variants[o].inventory_checked || l > 0) && (s = 1)),
                                                1 == e.product.variants[o].inventory_checked && (s > l || 0 == l) && (s = l),
                                                s <= 0 && (s = 1),
                                                (t.target.value = s);
                                        }
                                    }
                ...
                y = function (t, e, i, a, n, o) {
                    ...
                    var d = e.type,
                        ...
                        p = null;
                    if (
                        (l && "headline" == d && ((p = t.getElementsByClassName("ladi-headline")[0]), r.isEmpty(p) || (p.innerHTML = c)),
                        l && "paragraph" == d && ((p = t.getElementsByClassName("ladi-paragraph")[0]), r.isEmpty(p) || (p.innerHTML = c)),
                        l && "image" == d)
                    ) {
                        u = r.getOptimizeImage(c, t.clientWidth, t.clientHeight, !0, !1, !1, !0);
                        var m = t.getElementsByClassName("ladi-image-background")[0];
                        r.isEmpty(m) || (r.isEmpty(u) ? m.style.setProperty("background-image", "none") : (m.style.setProperty("background-image", 'url("' + u + '")'), o && r.runtime.tmp.updateImageGalleryProduct(t, c, e)));
                    }
                    if ("gallery" == d) {
                        ...
                        (_ = t.getElementsByClassName("ladi-gallery-control-item")[0]), (g = t.getElementsByClassName("ladi-gallery-view-item")[0]), r.isEmpty(g) || g.classList.add("selected"), r.isEmpty(_) || _.classList.add("selected");
                        var h = t.getElementsByClassName("ladi-gallery-control-box")[0];
                        if ((r.isEmpty(h) || h.style.removeProperty("left"), l)) {
                            for (var v = t.getElementsByClassName("ladi-gallery-view-item"); v.length < c.length; ) {
                                var E = r.createTmpElement("div", '<div class="ladi-gallery-view-item" data-index="' + v.length + '"></div>', null, !0);
                                t.getElementsByClassName("ladi-gallery-view")[0].appendChild(E);
                            }
                            for (; v.length > c.length; ) v[v.length - 1].parentElement.removeChild(v[v.length - 1]);
                            for (
                                var P = t.getElementsByClassName("ladi-gallery-control-item"),
                                    L = function (e) {
                                ...
                                var A = r.createTmpElement("div", '<div class="ladi-gallery-control-item" data-index="' + P.length + '"></div>', null, !0);
                                A.addEventListener("click", L), t.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(A);
                            }
                            ...
                            c.forEach(function (e, i) {
                                u = r.getOptimizeImage(e.src, f.clientWidth, f.clientHeight, !0, !1, !1, r.runtime.isClient);
                                ...
                                r.isEmpty(a) || a.style.setProperty("background-image", 'url("' + u + '")'),
                                    (u = r.getOptimizeImage(e.src, _.clientWidth, _.clientHeight, !0, !1, !1, r.runtime.isClient)),
                        ...
                        r.runtime.tmp.runGallery(t.id, t, !0, d), r.runtime.tmp.setGalleryStart(t.id, t);
                    }
                    "countdown_item" == d && r.runtime.tmp.runOptionCountdownItem(t.id, t, d, e["option.countdown_item_type"]),
                        "countdown" == d &&
                            r.runtime.tmp.runOptionCountdown(t.id, t, d, e["option.countdown_type"], e["option.countdown_minute"], e["option.countdown_daily_start"], e["option.countdown_daily_end"], e["option.countdown_endtime"]);
                },
                _ = function (t, e) {
                    var d = p * m,
                    ...
                    if (r.isObject(u) && r.isArray(u.products)) {
                        ...
                        var P = f.getElementsByClassName("ladi-collection-item");
                        if (0 == P.length) return;
                        var L = 0,
                            A = 0;
                        if (f.hasAttribute("data-max-option-length")) L = parseFloatLadiPage(f.getAttribute("data-max-option-length"));
                        else {
                            var w = f.querySelectorAll('.ladi-form [data-variant="true"]');
                            for (A = 0; A < w.length; A++) {
                                var S = w[A].getElementsByClassName("ladi-form-item-box");
                                S.length > L && (L = S.length);
                            }
                        }
                        var b = f.getElementsByClassName("ladi-collection-content")[0],
                            T = { className: P[0].className, innerHTML: P[0].innerHTML };
                        a && P[0].parentElement.removeChild(P[0]);
                        for (var C = b.getElementsByClassName("ladi-collection-page"); C.length < i; ) {
                            var O = document.createElement("div");
                            (O.className = "ladi-collection-page"), b.appendChild(O);
                        }
                        var I = C[i - 1],
                            N = I.getElementsByClassName("ladi-collection-item");
                        if (N.length != u.products.length) for (; N.length > 0; ) N[0].parentElement.removeChild(N[0]);
                        var k = function (t, i, a, n, c, d) {
                            ...
                            for (var u = 0; u < t.length; u++) {
                                ...
                                r.isEmpty(p) ||
                                    ...
                                    a &&
                                        (r.isFunction(r.runtime.tmp.runOptionAction) && r.runtime.tmp.runOptionAction(t[u], t[u].id, p.type, p),
                                        r.isFunction(r.runtime.tmp.runOptionHover) && r.runtime.tmp.runOptionHover(t[u], t[u].id, p.type, p["option.data_hover"]),
                                        g(t, t[u], e, p, i, k)),
                                    y(t[u], p, n, c, a, d));
                            }
                        };
                        for (A = 0; A < u.products.length; A++) r.isArray(u.products[A].options) && u.products[A].options.length > L && (L = u.products[A].options.length);
                        for (f.setAttribute("data-max-option-length", L), A = 0; A < u.products.length; A++)
                            if (!(N.length > A)) {
                                var D = document.createElement("div");
                                (D.className = T.className), I.appendChild(D), (D.innerHTML = T.innerHTML);
                                for (var x = D.getElementsByClassName("ladi-element"); r.isArray(u.products[A].options) && u.products[A].options.length < L; ) u.products[A].options.push({ is_tmp: !0 });
                                k(x, u.products[A], !0, null, !1, !1);
                            }
                        v && I.classList.add("last"),
    ...
    (LadiPageScriptV2.prototype.setDataReplaceElement = function (t, e, i, a, n) {
        ...
        for (var p = r.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), m = 0; m < p.length; m++) {
            ...
            if (!_) {
                ...
                g = this.convertDataReplaceStr(P, !1, null, !1, i);
            }
            if (!this.isNull(g)) {
                if (((y = this.isArray(g) ? g[0] : g), (y = this.isNull(y) ? "" : y), (y += ""), "INPUT" == p[m].tagName))
                    if ("checkbox" == (f = p[m].getAttribute("type").trim()) || "radio" == f) {
                        ...
                        if ("checkbox" == f) {
                            var A = g;
                            this.isArray(A) || (A = [A]), (L = -1 != A.indexOf(p[m].getAttribute("value")));
                        }
                        "radio" == f && (L = p[m].getAttribute("value") == y.trim()), L ? ((p[m].checked = !0), e && p[m].setAttribute("checked", "checked")) : ((p[m].checked = !1), e && p[m].removeAttribute("checked"));
    ...
    (LadiPageScriptV2.prototype.updateProductVariantSelectOption = function (t, e, i, a, n) {
        var r = this,
            o = t.target,
            l = r.generateVariantProduct(e, !1, null, null, null, null, !0, !0, function (o) {
        ...
        if (r.isObject(l)) {
            ...
            if (r.isEmpty(c))
                for (var p = document.querySelectorAll('[data-variant="true"]'), m = 0; m < p.length; m++) {
                    ...
                    if (!r.isEmpty(g) && ((g = r.findAncestor(g, "ladi-element")), r.isEmpty(r.findAncestor(g, "ladi-collection")))) {
                        var y = r.runtime.eventData[g.id];
                        r.isEmpty(y) || y["option.product_type"] != e["option.product_type"] || y["option.product_id"] != e["option.product_id"] || d.push(p[m]);
                    }
                }
            ...
            for (u = 0; u < d.length; u++) {
                if (a) {
                    ...
                    if ("POPUP_PRODUCT" != (f = r.findAncestor(f, "ladi-element")).id) continue;
                }
                _.push(d[u]);
            }
            var h = o.getAttribute("data-product-option-id"),
                ...
                E = null,
                P = null;
            if (r.isArray(l.product.variants) && l.product.variants.length > 0 && r.isString(l.product.variants[0].option_ids)) {
                ...
                r.isEmpty(E) ||
                    ...
                    l.product.variants.forEach(function (t) {
                        if (r.isEmpty(o.value) || o.value == t["option" + (E + 1)]) for (u = 0; u < P.length; u++) r.isArray(v[P[u]]) || (v[P[u]] = []), u != E && v[P[u]].push(t["option" + (u + 1)]);
                    }));
            }
            for (var L = [], A = 0; A < _.length; A++) {
                var w = r.runtime.eventData[_[A].id];
                if (!r.isEmpty(w) && w["option.product_variant_type"] == r.const.PRODUCT_VARIANT_TYPE.combobox) {
                    ...
                    if (r.isObject(v)) {
                        for (b = 0; b < S.length; b++)
                            if ((C = S[b].getAttribute("data-product-option-id")) != h)
                                for ((r.isArray(v[C]) && -1 != v[C].indexOf(S[b].value)) || (S[b].value = ""), O = S[b].getElementsByTagName("option"), T = 0; T < O.length; T++)
                                    r.isEmpty(O[T].getAttribute("value")) || O[T].removeAttribute("disabled");
                        for (b = 0; b < S.length; b++) {
                            (C = S[b].getAttribute("data-product-option-id")), (v = {});
                            for (var I = 0; I < l.product.variants.length; I++) {
                                var N = l.product.variants[I];
                                if (((P = N.option_ids.split("/")), -1 != (E = P.indexOf(C)) && (r.isEmpty(S[b].value) || S[b].value == N["option" + (E + 1)])))
                                    for (u = 0; u < P.length; u++) r.isArray(v[P[u]]) || (v[P[u]] = []), u != E && v[P[u]].push(N["option" + (u + 1)]);
                            }
                            for (var k = 0; k < S.length; k++) {
                                var D = S[k].getAttribute("data-product-option-id");
                                if (D != C)
                                    for (O = S[k].getElementsByTagName("option"), T = 0; T < O.length; T++)
                                        r.isEmpty(O[T].getAttribute("value")) || (r.isArray(v[D]) && -1 != v[D].indexOf(O[T].getAttribute("value"))) || O[T].setAttribute("disabled", "");
                            }
                        }
                    }
                    if (!r.isObject(v)) for (b = 0; b < S.length; b++) L.push(S[b]);
                }
            }
            !r.isEmpty(s) && r.isFunction(n) && n();
            for (var x = null; L.length > 0; ) (x = L.shift()), r.fireEvent(x, "change");
        }
    }),
        ...
        if (a.isObject(n) && a.isObject(n.product)) {
            ...
            if (a.isArray(n.product.variants) && 0 != n.product.variants.length) {
                ...
                if (
                    ...
                    for (o = 0; o < r.length; o++) (s = r[o].querySelector('option[data-product-variant-id="' + l.product_variant_id + '"]')), a.isEmpty(s) || ((r[o].value = s.getAttribute("value")), a.fireEvent(r[o], "change"));
                if (e["option.product_variant_type"] == a.const.PRODUCT_VARIANT_TYPE.combobox)
                    if (a.isString(l.option_ids))
                        l.option_ids.split("/").forEach(function (t, e) {
                            for (o = 0; o < r.length; o++) r[o].getAttribute("data-product-option-id") == t && ((r[o].value = l["option" + (e + 1)] || ""), a.fireEvent(r[o], "change"));
                        });
            } else for (o = 0; o < r.length; o++) (r[o].value = ""), a.fireEvent(r[o], "change");
        }
    }),
    ...
    (LadiPageScriptV2.prototype.getProductVariantId = function (t, e) {
        ...
        if (!this.isEmpty(a)) {
            ...
            if (!this.isEmpty(r) && r["option.product_variant_type"] == this.const.PRODUCT_VARIANT_TYPE.combobox) {
                for (var s = a.querySelectorAll(".ladi-form-item select[data-product-option-id]"), c = {}, d = 0; d < s.length; d++) c[s[d].getAttribute("data-product-option-id")] = (s[d].value || "").trim();
    ...
    (LadiPageScriptV2.prototype.getProductVariantIndex = function (t, e) {
        ...
        if (!i.isObject(l) || !i.isObject(l.store_info) || !i.isObject(l.product) || !i.isArray(l.product.variants) || l.product.variants.length <= 0) return a;
                              ...
                              if (!i.isEmpty(d)) {
                                  ...
                                  if (!i.isEmpty(u)) {
                                      if (u["option.product_variant_type"] == i.const.PRODUCT_VARIANT_TYPE.combobox) {
                                          var p = d.querySelectorAll(".ladi-form-item select[data-product-option-id]");
    ...
    (LadiPageScriptV2.prototype.generateProductKey = function (t, e, i, a, n, r, o) {
        ...
        var s = i["option.product_type"],
            ...
            d = l.generateVariantProduct(i, !1, null, null, null, null, !0, !0, function (e) {
            ...
            var p = null,
                m = function () {
                    if (s == l.const.FORM_CONFIG_TYPE.ladisales) {
                        if (
                            (-1 != ["name", "content"].indexOf(c) && ((p = d.product[c]), (t = p)),
                            -1 != ["description"].indexOf(c) && ((p = d.product[c]), (t = p)),
                            -1 != ["image"].indexOf(c) && ((p = d.product[c]), l.isObject(p) && ((t = p.src), l.isEmpty(t) || (t = "https://" + l.const.STATIC_W_DOMAIN + "/" + t))),
                            -1 != ["images"].indexOf(c) &&
                                ((p = d.product[c]),
                                l.isArray(p) &&
                                    ((t = []),
                                    p.forEach(function (e) {
                                        l.isEmpty(e.src) || t.push({ src: "https://" + l.const.STATIC_W_DOMAIN + "/" + e.src });
                                    }))),
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    -1 != ["title"].indexOf(c) && ((p = g[c] || g.product_name), (t = p)),
                                    -1 != ["text_quantity"].indexOf(c) && ((p = 1 == g.inventory_checked ? g[c] : ""), (t = p)),
                                    -1 != ["weight"].indexOf(c) && ((p = g[c]), l.isEmpty(g.weight_unit) || (p += g.weight_unit), (t = p)),
                                    -1 != ["price", "price_compare"].indexOf(c) &&
                                        (l.isEmpty(g[c])
                                            ? (p = "")
                                            : ((p = l.formatNumber(g[c], 3)),
                                              l.isObject(d.store_info) && l.isObject(d.store_info.currency) && !l.isEmpty(d.store_info.currency.symbol) && (p = l.formatCurrency(g[c], d.store_info.currency.symbol, !0))),
                                        (t = p)),
                                    -1 != ["src"].indexOf(c))
                                ) {
                                ...
                                -1 != ["description"].indexOf(c) && ((p = g[c]), l.isEmpty(p) || (t = p));
                            } else t = p = "";
                        }
                        if (-1 != ["description"].indexOf(c) && l.isEmpty(t)) return (c = "content"), m();
                    } else {
                        if (((p = d.product[c]), l.isBoolean(p))) p = p ? l.const.LANG.OPTION_TRUE : l.const.LANG.OPTION_FALSE;
                        else
                            try {
                                var y = new Date(p);
                                y.toISOString() == p && (p = y.getFullYear() + "-" + u(y.getMonth() + 1) + "-" + u(y.getDate()) + " " + u(y.getHours()) + ":" + u(y.getMinutes()) + ":" + u(y.getSeconds()));
                            } catch (t) {}
                        t = p;
                    }
                ...
                if (d.isObject(t)) {
                    ...
                    i == d.const.PRODUCT_VARIANT_TYPE.combined &&
                        ((l +=
                            ...
                            ">"),
                        d.runtime.isClient && (l += '<option value="" data-product-variant-id="">' + d.const.LANG.OPTION_NO_SELECT + "</option>"),
                            ...
                            t.product.options.forEach(function (e) {
                                if (e.is_tmp) l += '<div class="ladi-form-item-box"></div>';
                                    ...
                                    (l += '<div class="ladi-form-item-box">'),
                                        d.isEmpty(a) || (l += '<div class="ladi-form-item-title"><span>' + e.name + "</span></div>"),
                                        (l +=
                                            '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select data-store-id="' +
                                            t.store_info.id +
                                            '" data-product-id="' +
                                            ...
                                            (o ? "" : ' onmousedown="javascript: event.preventDefault();"') +
                                            ">"),
                                        d.runtime.isClient && (l += '<option value="">' + d.const.LANG.OPTION_NO_SELECT + "</option>");
                                    var i = null;
                                    ...
                                    e.values.forEach(function (t) {
                                        ...
                                        l += "<option" + a + ' value="' + t.name + '">' + t.name + "</option>";
                                    }),
                ...
                if (
                    ...
                    return (
                        d.runLimitRequest(20, function () {
                            d.sendRequest("POST", d.const.API_SHOW_PRODUCT, JSON.stringify(P), !0, { "Content-Type": "application/json", "Store-Id": m }, function (t, e, i) {
                                if (i.readyState == XMLHttpRequest.DONE)
                                    try {
                                        if (d.isObject(d.runtime.tmp.product_info[m][g])) v = d.runtime.tmp.product_info[m][g];
                                        else {
                                            var a = JSON.parse(t);
                                            v = a.data;
                                        }
                                        d.isObject(v)
                                            ? ((d.runtime.tmp.product_info[m][g] = v), (c = E()), d.isFunction(s) && s(c))
                                            : ((d.runtime.tmp.product_info[m][g] = !1),
                                              d.isEmpty(d.runtime.tmp.timeout_product_info[m][g]) || (d.removeTimeout(d.runtime.tmp.timeout_product_info[m][g]), delete d.runtime.tmp.timeout_product_info[m][g]));
                                    } catch (t) {
                                        (d.runtime.tmp.product_info[m][g] = !1),
                                            d.isEmpty(d.runtime.tmp.timeout_product_info[m][g]) || (d.removeTimeout(d.runtime.tmp.timeout_product_info[m][g]), delete d.runtime.tmp.timeout_product_info[m][g]);
                                    }
            ...
            if (
                ...
                if (r.runtime.isClient)
                    ...
                    var P = function (t) {
                        ...
                        L = LadiPage.mapping_attribute_option_product_id(t.element, "", s, e, i, !1, !0, function (t) {
                            P(t);
                        });
                    P(L);
                }
            ...
            this.isArray(this.runtime.tmp.cart) &&
                ...
                this.runtime.tmp.cart.forEach(function (i) {
                    if (!(i.quantity <= 0)) {
                        ...
                        var n = [[i.product_variant_id, i.quantity, i.price, i.weight, i.weight_unit].join(":"), a].join("|");
                        t.push(n);
                    }
                })),
            t
    ...
    (LadiPageScriptV2.prototype.getCartCheckoutPrice = function (t) {
        ...
        return this.isArray(this.runtime.tmp.cart) && !this.isEmpty(e) ? this.changeTotalPriceCart(!0).cart_checkout_price : t;
    }),
    ...
    lightbox_run = function (t, e, i, a, n, r, o, l) {
        ...
        if (!LadiPageScript.isEmpty(s)) {
            ...
            if (
                ...
                var L = "body {";
                (L += "position: fixed !important;"), (L += "width: 100% !important;"), (L += "top: -" + E + "px"), (L += "}"), LadiPageScript.createStyleElement("style_lightbox", L);
            }
...
(LadiPageLibraryV2.prototype.get_url = function (t, e) {
    ...
    (LadiPageLibraryV2.prototype.scroll = function () {
        ...
        if (!LadiPageScript.isEmpty(t)) {
            for (var e = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), i = 0; i < e.length; i++)
                if (e[i].id != this.id && e[i].hasAttribute("data-popup-backdrop") && "block" == e[i].style.getPropertyValue("display")) {
                    var a = LadiPageScript.findAncestor(t, "ladi-popup");
                    LadiPageScript.isEmpty(a) || (a = LadiPageScript.findAncestor(a, "ladi-element")), (LadiPageScript.isEmpty(a) || a.id != e[i].id) && LadiPageScript.runRemovePopup(e[i].id, !0);
                }
            var n,
                ...
                o = function (t, e, i) {
                    ...
                    var a = function (t, e, i, a) {
                        ...
                        n = "left" == t ? e.scrollLeft : e.scrollTop,
                        o = "left" == t ? window.innerWidth : window.innerHeight,
                        l = i - n;
                    if (0 != l) {
                        var s = l < 0 ? -1 * l : l,
                            c = 0,
                            d = 1e3;
                        (d = s <= 4 * o ? 750 : d), (d = s <= 2 * o ? 525 : d), (d = s <= o ? 300 : d), (d = r ? 300 : d);
                        ...
                        if (p) {
                            ...
                            p(
                                (m = function () {
                                    (c = d - (g - Date.now())), (e[u] = a(c, n, l, d)), c < d ? p(m) : (e[u] = i);
                                })
                            );
                        } else
                            (m = function () {
                                (c += 20), (e[u] = a(c, n, l, d)), c < d ? (LadiPageScript.runtime.tmp.scroll_timeout_id = LadiPageScript.runTimeout(m, 20)) : (e[u] = i);
                            })();
                    }
                },
                l = function (e) {
                    var i = LadiPageScript.getElementBoundingClientRect(t).top + e.scrollTop,
                        a = 0,
                        n = 0,
                        r = Object.keys(LadiPageScript.runtime.eventData),
                        o = LadiPageScript.runtime.isDesktop ? LadiPageScript.const.DESKTOP : LadiPageScript.const.MOBILE;
                    return (
                        r.forEach(function (e) {
                            var i = LadiPageScript.runtime.eventData[e];
                            if ("section" == i.type && i[o + ".option.sticky"] && i[o + ".option.sticky_position"] == LadiPageScript.const.POSITION_TYPE.top) {
                                var r = document.getElementById(e);
                                LadiPageScript.isEmpty(r) ||
                                    (t.id != e && ((n = parseFloatLadiPage(i[o + ".option.sticky_position_top"]) || 0), (a = (parseFloatLadiPage(getComputedStyle(r).height) || 0) + n), "fixed" != getComputedStyle(r).position && (a *= 2)));
                            }
                        }),
                ...
                s = null;
            if (r)
                if (LadiPageScript.runtime.isDesktop) t.scrollIntoView({ behavior: "smooth" });
                else {
                    var c = document.getElementsByClassName("ladi-wraper")[0];
                    LadiPageScript.runtime.story_page.type == LadiPageScript.const.STORY_PAGE.horizontal && ((n = c), o("left", c, { scrollLeft: LadiPageScript.getElementBoundingClientRect(t).left + n.scrollLeft }.scrollLeft)),
                        LadiPageScript.runtime.story_page.type == LadiPageScript.const.STORY_PAGE.vertical && o("top", c, (s = l(c)).scrollTop);
                }
            else (s = l(document.documentElement)), LadiPageScript.runtime.isDesktop ? window.scrollTo({ top: s.scrollTop, behavior: "smooth" }) : o("top", document.documentElement, s.scrollTop);
        }
    }),
    ...
    (LadiPageLibraryV2.prototype.top = function () {
        ...
        if (!LadiPageScript.isEmpty(t) && t.classList.contains("ladi-section"))
            try {
                t.parentElement.insertBefore(t, t.parentElement.firstChild), LadiPageScript.reloadLazyload(!1);
            } catch (t) {}
    }),
                ...
                return (
                    ...
                    LadiPageScript.isEmpty(t)
                        ...
                        : (("gallery" != i.type && "carousel" != i.type) || ((t -= 1), (a -= 1)),
                          t == a
                              ? ("carousel" == i.type && e.setAttribute("data-stop", !0), void ("gallery" == i.type && e.hasAttribute("data-loaded") && e.setAttribute("data-stop", !0)))
                              : void (t > a
    ...
    (LadiPageLibraryV2.prototype.hide = function () {
        ...
        LadiPageScript.isEmpty(t) ||
            (0 == t.getElementsByClassName("ladi-popup").length
                ? (t.style.setProperty("display", "none", "important"), LadiPageScript.reloadLazyload(!1))
    ...
    (LadiPageLibraryV2.prototype.show = function () {
        ...
        if (!LadiPageScript.isEmpty(t)) {
            ...
            0 == t.getElementsByClassName("ladi-popup").length
                ? (t.style.setProperty("display", "block", "important"), i(), LadiPageScript.runResizeSectionBackground(), LadiPageScript.reloadLazyload(!1))
